(function () {
  ...
  if (!bloque) {
    alert('[OrdenExtractor] No se encontró el bloque expandido. No se encontro la orden con la que etsa Asegúrate de seleccionar la orden con la que esta trabajando');
    return;
  }
