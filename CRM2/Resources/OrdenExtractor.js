(function () {
  ...
  if (!bloque) {
    alert('[OrdenExtractor] Error No se encontró el bloque expandido. No se encontro la orden con la que estas trabajando Asegúrate de seleccionar la orden con la que esta trabajando');
    return;
  }
